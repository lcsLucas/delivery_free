...
$todas_entradas = $entrada->listarRelatorio($periodo1, $periodo2);
$total_entradas = 0;
$total_frete = 0;
$total_desconto = 0;
...
$titulo = "Relatório das Entradas de insumos";
$subtitulo = "Relação de todas as entrada de insumos" . (!empty($periodo1) ? '<br>no período de ' . $periodo1. ' a ' . $periodo2 : '');
