...
$subtitulo = "Relação de todas as contas a pagar" . (!empty($periodo1) ? '<br>com o vencimento no período ' . $periodo1. ' a ' . $periodo2 : '');
...
$html .= '<tr>'
	...
	. '<td class="center" style="background: #F1F1F1;"> <b>Nº da Parcela</b> </td>'
...
if(!empty($todas_contas)){
	...
	foreach ($todas_contas as $conta){
		...
		$html .= '<tr>';
		$html .= '<td class="center">'. $conta['ent_id'] .'<td/>';
		$html .= '<td class="center">'. $conta['con_numParcela'] .'<td/>';
