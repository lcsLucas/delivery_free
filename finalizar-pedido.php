                        ...
                        <div class="border p-3">
                            ...
                            ?>
                                ...
                                <p id="endereco-selecionado" class="m-0">
                                    <i class="fa fa-check-circle text-success mr-3"></i> <span><?= $todos_endereco[0]['end_rua'] . ', ' . $todos_endereco[0]['end_numero'] . ' - ' . $todos_endereco[0]['cid_nome']  . ' | ' . $todos_endereco[0]['end_descricao'] ?></span> <a id="mostrar-enderecos" class="float-right" href="">alterar endereço</a>
                                </p>
                                    ...
                                    ?>
                                        ...
                                        <div class="form-check m-1">
                                            ...
                                            <label class="form-check-label" for="check-endereco<?= $i ?>">
                                                <?= substr($endereco['end_descricao'], 0, 15) ?> - <?= $endereco['end_rua'] ?>, <?= $endereco['end_numero'] ?> - <?= $endereco['cid_nome'] ?>
                                            </label>
                                        </div>
