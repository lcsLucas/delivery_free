                    ...
                    ?>
                        ...
                        <div class="avaliacao-pedido">
                            ...
                            <header class="d-flex justify-content-between">
                                <span>PEDIDO #<?= str_pad($naoava['idsaida'], 5, '0', STR_PAD_LEFT) ?> - <?= $naoava['emp_nome'] ?> (R$<?= number_format($naoava['total_geral'], 2, ',', '.') ?>)</span>
                    ...
                    <div class="avaliacao-realizada border">
                        ...
                        <div class="header">
                            ...
                            <h4 class="text-uppercase font-weight-bold mb-1">
                                PEDIDO #<?= str_pad($avaliados['idsaida'], 5, '0', STR_PAD_LEFT) ?> - <?= $avaliados['emp_nome'] ?>
