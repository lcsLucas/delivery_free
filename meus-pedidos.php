                    ...
                    <div class="body py-0 px-3">
                        ...
                        ?>
                                ...
                                <div class="produto clearfix border-bottom py-3 m-0">
                                    <?= $produto['nome'] ?> <span class="float-right">R$ <?= number_format(!empty($produto['prom_valor']) ? $produto['prom_valor'] : $produto['preco'], 2, ',', '.') ?> <span class="font-weight-light mx-2" style="font-size: .85rem;">x</span> <?= str_pad($produto['qtde'], 2, '0', STR_PAD_LEFT) ?></span>
                                    ...
                                    ?>
                                        <div class="pl-4 complementos text-muted font-weight-light">
                                            ...
                                            ?>
                                                ...
                                                <p class="m-0">
                                                    - <?= $complemento['nome'] ?> <span class="float-right">+R$ <?= number_format($complemento['preco'], 2, ',', '.') ?></span>
                                                </p>
