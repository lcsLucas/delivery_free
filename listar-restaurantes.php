        ...
        <div class="row">
            ...
            ?>
                ...
                <div class="col-sm-12 col-md-6">
                    ...
                    <a href="<?= $baseurl ?>restaurante/<?= $restaurante['emp_id'] ?>/<?= tiraAcentos2($restaurante['emp_nome']) ?>">

                        <div class="media restaurante mb-4">
                            <div class="wrapper-img align-self-center">
                                <img src="img/restaurantes/logos/<?= $restaurante['emp_logo'] ?>" class="img-responsive w-100 d-block" alt="logo <?= $restaurante['emp_nome'] ?>">
                            </div>
                            <div class="media-body">
                                <h3 class="titulo-restaurante m-0"><?= $restaurante['emp_nome'] ?></h3>

                                <div class="info-restaurante mt-2">

                                    <p class="m-0"><i class="fas fa-utensils mr-1"></i> <?= $restaurante['categoria'] ?></p>
